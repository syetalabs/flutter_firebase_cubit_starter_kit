...
class OnboardKitA extends StatefulWidget {
  static const routeName = '/onboarding-kit-a';
  @override
  _OnboardKitAState createState() => _OnboardKitAState();
}

class _OnboardKitAState extends State<OnboardKitA> {
  bool isLast = false;
